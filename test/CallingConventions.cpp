...
bool TextArea_init(
    TextArea* ecx, GDString stack4, char const* stack1, float xmm2, float xmm3, CCPoint stack5, float stack2,
    bool stack3
) {
    return true;
}
...
TextArea* TextArea_create(
    GDString stack1, char const* ecx, float xmm1, float xmm2, CCPoint stack2, float xmm3,
    bool edx
) {
    return nullptr;
}
