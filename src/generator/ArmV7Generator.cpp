...
std::vector<uint8_t> ArmV7Generator::handlerBytes(
...
geode::Result<BaseGenerator::RelocateReturn> ArmV7Generator::relocatedBytes(
    ...
    GenRelocateCodeAndBranch(const_cast<uint8_t*>(originalBuffer.data()) + 1, relocatedBuffer.data(), originMem,
        relocatedMem, +[](void* dest, void const* src, size_t size) {
