...
namespace tulip::hook {
	...
	public:
		...
		virtual WrapperReturn wrapperBytes(int64_t original, int64_t wrapper, WrapperMetadata const& metadata);
		virtual std::vector<uint8_t> runtimeInfoBytes(int64_t function, size_t size, int64_t push, int64_t move, int64_t alloc);
