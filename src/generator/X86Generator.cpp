...
std::vector<uint8_t> X86Generator::handlerBytes(
...
geode::Result<BaseGenerator::RelocateReturn> X86Generator::relocatedBytes(
...
geode::Result<> X86Generator::relocateInstruction(
    cs_insn* insn, uint8_t* buffer, uint64_t& trampolineAddress,
    uint64_t& originalAddress, int64_t relocated, size_t originalTarget
) {
...
geode::Result<> X86Generator::relocateRIPInstruction(
    cs_insn* insn, uint8_t* buffer, uint64_t& trampolineAddress,
...
geode::Result<> X86Generator::relocateBranchInstruction(
    cs_insn* insn, uint8_t* buffer, uint64_t& trampolineAddress,
