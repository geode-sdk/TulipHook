...
HookHandle tulip::hook::createHook(
    HandlerHandle const& handler, void* function,
...
RelocaledBytesReturn tulip::hook::getRelocatedBytes(
...
std::vector<uint8_t> tulip::hook::getCommonIntervenerBytes(
